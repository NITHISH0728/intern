        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-6 md:gap-8">
          ...
          <div>
            ...
            <textarea
              ...
              required
              className="w-full p-3 text-sm rounded-lg border border-slate-300 focus:border-[#005EB8] focus:ring-1 focus:ring-[#005EB8] outline-none transition-all resize-y"
            />
          </div>
