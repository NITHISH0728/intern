...
import {
    ...
    Zap, CheckSquare, Square, CheckCheck, Award, Edit, AlertTriangle, Maximize, Minimize, LockKeyhole // <--- Added 'Check' icon here
} from "lucide-react";
            ...
            <div className="w-full lg:w-[60%] h-[500px] lg:h-full flex flex-col gap-4 shrink-0">
                ...
                <div className="flex-[1.5] flex flex-col gap-4 min-h-[200px]">
                    ...
                    <div className="flex-[0.2] flex gap-3">
                        <button onClick={saveProgress} className="flex-1 bg-white border-2 border-slate-200 text-slate-700 hover:border-slate-300 hover:bg-slate-50 font-bold rounded-xl flex items-center justify-center gap-2 transition-all text-sm lg:text-base p-2"><Save size={18} /> Save</button>
                        <button onClick={runCode} disabled={loading} className="flex-1 bg-[#005EB8] hover:bg-[#004a94] text-white font-bold rounded-xl flex items-center justify-center gap-2 transition-all disabled:opacity-70 text-sm lg:text-base p-2">{loading ? <Cpu size={18} className="animate-spin" /> : <Play size={18} />} {loading ? "Running..." : "Run Code"}</button>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div className="w-full lg:w-[65%] flex flex-col h-[60vh] lg:h-full gap-4 shrink-0">
                    ...
                    <div className="flex-[1] bg-[#0f172a] rounded-2xl shadow-sm border border-slate-800 overflow-hidden flex flex-col min-h-[150px]">
                        ...
                        <div className="p-3 lg:p-4 bg-slate-800 flex justify-end gap-4 shrink-0">
                            <button onClick={runAndSubmit} disabled={loading} className="px-6 py-2 lg:px-8 lg:py-3 rounded-xl bg-[#005EB8] hover:bg-[#004a94] text-white font-bold shadow-lg flex items-center gap-2 transition-all text-sm lg:text-base">
